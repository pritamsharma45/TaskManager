  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <h6>Edit Invoice Details</h6>
        <invoice-modal
          :items="invoice_modal.items"
          :clientId="invoice_modal.client_id"
          :invoice_details="invoice_modal.invoice_details"
    ...
    <div>
      ...
      >
        ...
        <template #modal-footer>
          <div class="float-right">
            <b-button variant="danger" size="sm" @click="deleteInvoice">
              Delete Invoice
            </b-button>
            <b-button
              variant="primary"
...
export default {
  ...
  methods: {
    ...
    saveInvoice() {
      ...
      // if (clientId === "") {
      //   //
      //   this.$bvToast.toast("No client selected. !", {
      //     title: `Select Client`,
      //     variant: "warning",
      //     solid: true,
      //   });
