<template>
  <b-card class="m-1 py-0" no-body style="max-width: 60rem">
    <b-card-header class="m-1 py-0" header-tag="nav">
      <b-nav card-header pills small class="m-1 py-0" style="font-size: 1em">
        <b-nav-item
          v-for="nav in navs"
          class="m-1 py-0"
          :key="nav.id"
