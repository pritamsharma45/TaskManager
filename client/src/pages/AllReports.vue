...
export default {
  ...
  data() {
    return {
      taskStatus: "Pending",
      taskType: "",
      exportClientType: { text: "All Tasks", value: "All" },
      exportItems: [],
      ...
      clientOptions: [
        { text: "Active clients", value: "A" },
        { text: "In-active clients", value: "D" },
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Client Type",
          formatter: (value) => {
            return configStore.state.indexedDropdowns["tbl_company_type"][
              value
            ]["company_type"];
          },
        },
  ...
  methods: {
    ...
    fetchItems() {
      ...
      items = items.map((item) => {
        const companyType =
          this.configStore.state.indexedDropdowns["tbl_company_type"][
            item.company_type_id
          ]["company_type"];
        item.company_type_id = companyType;
        return item;
      });
      return items;
    },
